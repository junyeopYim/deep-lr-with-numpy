...
output=Path('/tmp/dlfs-architectures/rehearsal08')
source=root/'notebooks/01_아키텍처/08_attention.ipynb'
...
notebook.cells.append(nbformat.v4.new_markdown_cell('# 독립 실행자가 작성한 Attention 변형과 검산'))
